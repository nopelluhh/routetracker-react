    ...
    render() {
      ...
      <tr className={ 'table-center ' + (this.props.selected ? 'route-row__selected' : '') }>
        ...
        <td>
          <select
            ...
            { this.props.team.members.map(setter => (<option key={ setter._id } value={ setter.nickname }>
                                                       { setter.nickname }
                                                     </option>)) }
          </select>
        </td>
      ...
      <tr className={ 'table-center ' + (this.props.selected ? 'route-row__selected' : '') }>
        <td className="gym-row__date">
          ...
          <div className="hidden-md-down">{ ' (' + dateMath.weeksOld(this.props.route.set_on) + ' weeks old)' }</div>
        </td>
        <td>
